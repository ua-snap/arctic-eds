export default {
  layers: {
    ...
    permafrost: [
      ...
      },
      {
        ...
        title:
          'Mean annual ground temperature at 1 m depth, 2071-2100 (5-Model Average, RCP 8.5), GIPL model',
        source: 'rasdaman',
        wmsLayerName: 'crrel_gipl_outputs_nc',
  ...
  legends: {
    precipitation: [
      { color: '#8c510a', label: '&ge;0&#8239;in, &lt;10&#8239;in' },
      { color: '#d8b365', label: '&ge;10&#8239;in, &lt;20&#8239;in' },
      { color: '#f6e8c3', label: '&ge;20&#8239;in, &lt;50&#8239;in' },
      { color: '#c7eae5', label: '&ge;50&#8239;in, &lt;100&#8239;in' },
      { color: '#5ab4ac', label: '&ge;100&#8239;in, &lt;200&#8239;in' },
      { color: '#01665e', label: '&ge;200&#8239;in' },
    ],
    snowfall: [
      { color: '#edf8fb', label: '&ge;0&#8239;in, &lt;2.5&#8239;in' },
      { color: '#bfd3e6', label: '&ge;2.5&#8239;in, &lt;5&#8239;in' },
      { color: '#9ebcda', label: '&ge;5&#8239;in, &lt;10&#8239;in' },
      { color: '#8c96c6', label: '&ge;10&#8239;in, &lt;20&#8239;in' },
      { color: '#8856a7', label: '&ge;20&#8239;in, &lt;50&#8239;in' },
      { color: '#810f7c', label: '&ge;50&#8239;in' },
    ],
    wet_days_per_year: [
