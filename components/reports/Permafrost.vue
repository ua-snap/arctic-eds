  ...
  <div v-if="isPermafrostPresent">
    <div class="block">
      ...
      <div class="content is-size-5">
        <p>
          The following results are Geophysical Institute Permafrost Lab (GIPL) 2.0 model outputs generated by driving the GIPL 2.0 model with downscaled and bias corrected climate simulations representing three different models (GFDL CM3 and NCAR CCSM4, as well as a 5-model average of GFDL CM3, NCAR CCSM4, GISS E2-R, IPSL CM5A-LR, MRI CGCM3) and two emissions scenarios (RCP 4.5 and RCP 8.5). Model selection was based on the models&rsquo; superior historical performance for the Alaska region for three variables: surface air temperature, precipitation, and sea level pressure. GIPL 2.0 model outputs include annual projections of permafrost top and base depths, talik thickness, and mean annual ground temperature at seven different depths for years 2021 through 2120. The GIPL-2.0 model simulates soil temperature dynamics and the depth of seasonal freezing and thawing by solving nonlinear heat equations with phase change numerically. The GIPL 2.0 model is a research product developed by the Permafrost Laboratory at the Geophysical Institute at the University of Alaska Fairbanks. The available data extent is the terrestrial area of Alaska. The spatial resolution (grid cell size) of all data is 1 by 1 km.
        </p>
      </div>
    </div>
    <div class="block">
