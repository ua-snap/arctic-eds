      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              {{ signedDiff(results.gipl_magt_1995, results.gipl_magt_2025, 'magt') }}<UnitWidget type="light" />
            </td>
          </tr>
          <tr>
            ...
            <td>
              {{ signedDiff(results.gipl_magt_1995, results.gipl_magt_2050, 'magt') }}<UnitWidget type="light" />
            </td>
          </tr>
          <tr>
            ...
            <td>
              {{ signedDiff(results.gipl_magt_1995, results.gipl_magt_2075, 'magt') }}<UnitWidget type="light" />
            </td>
          </tr>
          <tr>
            ...
            <td>
              {{ signedDiff(results.gipl_magt_1995, results.gipl_magt_2095, 'magt') }}<UnitWidget type="light" />
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <div v-if="results.gipl_alt_1995">
        ...
        <table class="table">
          ...
          <tbody>
            <tr>
              <th scope="row">Historical (1995)</th>
              <td>{{ results.gipl_alt_1995 }}<UnitWidget unitType="m_in" type="light" /></td>
              <td></td>
            </tr>
            <tr>
              <th scope="row">2011 - 2040</th>
              <td>{{ results.gipl_alt_2025 }}<UnitWidget unitType="m_in" type="light" /></td>
              <td>
                {{ signedDiff(results.gipl_alt_1995, results.gipl_alt_2025, 'alt') }}<UnitWidget unitType="m_in" type="light" />
              </td>
            </tr>
            <tr>
              <th scope="row">2036 - 2065</th>
              <td>{{ results.gipl_alt_2050 }}<UnitWidget unitType="m_in" type="light" /></td>
              <td>
                {{ signedDiff(results.gipl_alt_1995, results.gipl_alt_2050, 'alt') }}<UnitWidget unitType="m_in" type="light" />
              </td>
            </tr>
            <tr>
              <th scope="row">2061 – 2090</th>
              <td>{{ results.gipl_alt_2075 }}<UnitWidget unitType="m_in" type="light" /></td>
              <td>
                {{ signedDiff(results.gipl_alt_1995, results.gipl_alt_2075, 'alt') }}<UnitWidget unitType="m_in" type="light" />
              </td>
            </tr>
            <tr>
              <th scope="row">2086 – 2100</th>
              <td>{{ results.gipl_alt_2095 }}<UnitWidget unitType="m_in" type="light" /></td>
              <td>
                {{ signedDiff(results.gipl_alt_1995, results.gipl_alt_2095, 'alt') }}<UnitWidget unitType="m_in" type="light" />
              </td>
            </tr>
          </tbody>
        </table>
